...
def helpfulness_node(state: AgentState) -> Dict[str, Any]:
    ...
    prompt_template = """
  Given an initial query and a final response, determine if the final response is extremely helpful or not. Please check for accuracy and provide chain of thought reasoning for your answer. Please indicate helpfulness with a 'Y' and unhelpfulness as an 'N'.
